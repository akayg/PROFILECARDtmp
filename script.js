...
const Header = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("span", { className: "line" }, "Development"), /*#__PURE__*/
...
const About = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("p", null, "I really enjoy solving problems as well as making things pretty and easy to use. I can't stop learning new things; the more, the better. I also love Linux, a hobby I'm taking along since the good old film cameras. Oh, and rice with Kaddi; I am foodie too :)")), /*#__PURE__*/
    ...
    React.createElement("h4", { className: "subtitle" }, "I'm a Developer."), /*#__PURE__*/
    React.createElement("p", null, "For the front-end I usually work with Javascript, either standalone or including popular frameworks . I also make the web pretty by using Sass, CSS and, whenever needed, any of their friends: Bootstrap, Bulma, etc."), /*#__PURE__*/




    React.createElement("p", null, "For the back-end I also work with Javascript. But, of course, whenever the project requires PHP, I do PHP as well (Wordpress, Laravel, etc).")), /*#__PURE__*/




    React.createElement("div", { className: "desc" }, /*#__PURE__*/
    React.createElement("h4", { className: "subtitle" }, "Also a Digital Marketer."), /*#__PURE__*/
    React.createElement("p", null, "I feel comfortable working with many ADS product.Google,Meta, SEO PowerSuite, SnapchatAds or as per requirment are some kind of industry standards and I love working with them. I'm not limited to them, though: Semrush, Linkedin or Youtube are also very valid applications that I've been working with."), /*#__PURE__*/
...
const SocialLinks = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("a", {
      href: "https://twitter.com/abhishekgoreAK",
      target: "_blank",
